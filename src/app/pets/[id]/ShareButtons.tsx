...
export function ShareButtons({
  ...
  // Use absolute URL for share links
    ...
    <div className="space-y-2.5">
      ...
      <div className="flex flex-wrap gap-2">
        ...
        >
          {copied ? (
            <>
              <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" className="text-accent-500"><path d="M20 6L9 17l-5-5"/></svg>
              Copied!
            </>
          ) : (
            <>
        ...
        <a
          ...
          className="flex items-center gap-2 px-3.5 py-2 rounded-lg text-sm font-medium bg-[#1877F2] text-white hover:bg-[#166FE5] transition-colors"
        >
        ...
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="flex items-center gap-2 px-3.5 py-2 rounded-lg text-sm font-medium bg-surface-900 text-white hover:bg-surface-800 transition-colors"
        >
        ...
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="flex items-center gap-2 px-3.5 py-2 rounded-lg text-sm font-medium bg-[#25D366] text-white hover:bg-[#20BD5A] transition-colors"
        >
